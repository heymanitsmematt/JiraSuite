...
namespace TechTalk.JiraRestClient
{
    ...
    public class JiraClient : IJiraClient
    {
        ...
        public IEnumerable<Issue> GetIssuesByQuery(string projectKey, string issueType, string jqlQuery, string[] fields)
        {
            return client.GetIssuesByQuery(projectKey, issueType, jqlQuery, fields).Select(Issue.From).ToArray();
        }
